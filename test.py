...
input_message = st.chat_input(placeholder="I want a pie chart instead of a bar chart")
...
if input_message:
    ...
    context = """Snippet(s) of the user's files: Snippet(s) of the user's files: 'user_uploaded_files/02-24-2022_THROUGH_09-04-2024_Vehicle_Losses.csv': "Columns and Data Types:
  - id: int64
  - lat: string
  - lon: string
...
These are the file path(s): ['user_uploaded_files/02-24-2022_THROUGH_09-04-2024_Vehicle_Losses.csv']"""
    ...
    corrected_code = correct_code_remotely(refined_code, "Extra context for correction", FILENAME)
