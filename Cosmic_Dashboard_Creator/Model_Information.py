...
st.write("The dashboard creator uses a combination of OpenAI, Groq, and Google Large Language Models. The OpenAI models are accessed free via GitHub Marketplace, and the Groq models are accessed free via the Groq API. The Google gemini models are accessed via the free tier of Google AI Studio and Google Cloud.")
